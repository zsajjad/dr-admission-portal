 ...
 * Student gender
 */
export type AdmissionsDashboardGenderStatusStatGender =
  (typeof AdmissionsDashboardGenderStatusStatGender)[keyof typeof AdmissionsDashboardGenderStatusStatGender];

export const AdmissionsDashboardGenderStatusStatGender = {
  FEMALE: 'FEMALE',
  MALE: 'MALE',
} as const;
 ...
 * Admission status
 */
export type AdmissionsDashboardGenderStatusStatStatus =
  (typeof AdmissionsDashboardGenderStatusStatStatus)[keyof typeof AdmissionsDashboardGenderStatusStatStatus];

export const AdmissionsDashboardGenderStatusStatStatus = {
  UNVERIFIED: 'UNVERIFIED',
  VERIFIED: 'VERIFIED',
  REJECTED: 'REJECTED',
  DUPLICATE_MERGED: 'DUPLICATE_MERGED',
...
export interface AdmissionsDashboardGenderStatusStat {
  /** Student gender */
  gender: AdmissionsDashboardGenderStatusStatGender;
  /** Admission status */
  status: AdmissionsDashboardGenderStatusStatStatus;
  /** Number of admissions for this gender + status combination */
  count: number;
}
...
export interface AdmissionsDashboardResponseData {
  ...
  /** Admission counts cross-tabulated by gender and status */
  genderStatusStats: AdmissionsDashboardGenderStatusStat[];
