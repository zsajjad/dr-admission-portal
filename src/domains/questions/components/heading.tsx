...
export default function Heading({
  ...
  return (
    <PageHeading
      ...
      onAddPress={showAddButton ? () => route({ url: routes.questions.create }) : undefined}
      onEditPress={showEditButton ? () => route({ url: routes.questions.edit(id as string) }) : undefined}
